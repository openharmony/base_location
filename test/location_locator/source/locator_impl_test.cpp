...
HWTEST_F(LocatorImplTest, locatorImplEnableAbilityV9001, TestSize.Level1)
{
    ...
    locatorImpl_->SetLocationPrivacyConfirmStatusV9(1, true);
...
HWTEST_F(LocatorImplTest, IsPoiServiceSupported, TestSize.Level1)
{
    GTEST_LOG_(INFO)
        << "LocatorImplTest, IsPoiServiceSupported, TestSize.Level1";
    LBSLOGI(LOCATOR, "[LocatorImplTest] IsPoiServiceSupported begin");
...
HWTEST_F(LocatorImplTest, locatorImplGetAppsPerformLocating001, TestSize.Level1)
{
    GTEST_LOG_(INFO)
        << "LocatorImplTest, locatorImplGetAppsPerformLocating001, TestSize.Level1";
