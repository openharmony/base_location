...
HWTEST_F(CommonUtilsTest, GetRemoteObjectTest001, TestSize.Level1)
{
    ...
    // inert to map
    CommonUtils::GetRemoteObject(LOCATION_GNSS_SA_ID);
    CommonUtils::GetRemoteObject(LOCATION_NETWORK_LOCATING_SA_ID);
    CommonUtils::GetRemoteObject(LOCATION_NOPOWER_LOCATING_SA_ID);
