 ...
 */
#ifndef CHECKMESSAGE_FUZZER_H
#define CHECKMESSAGE_FUZZER_H
#include <thread>
...
namespace OHOS {
namespace Location {
#define FUZZ_PROJECT_NAME "checkmessage_fuzzer"

bool CheckMessageFuzzTest(const uint8_t* data, size_t size);
} // namespace Location
} // namespace OHOS
