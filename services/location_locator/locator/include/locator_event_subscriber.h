...
constexpr const char* LOCATION_CUST_CONFIG_POLICY_CHANGE = "usual.event.CUST_CONFIG_POLICY_UPDATED";
constexpr const char* PACKAGE_REMOVED_EVENT = "usual.event.PACKAGE_REMOVED";
