...
napi_value LocatingRequiredDataTypeConstructor(napi_env env)
{
    ...
    SetEnumPropertyByInteger(env, locatingPriority, LocatingRequiredDataType::BLUE_TOOTH, "BLUETOOTH");
...
static napi_value Init(napi_env env, napi_value exports)
{
    ...
    napi_property_descriptor desc[] = {
        ...
        DECLARE_WRITABLE_NAPI_FUNCTION("getAddressesFromLocation", GetAddressesFromLocation),
        DECLARE_WRITABLE_NAPI_FUNCTION("getAddressesFromLocationName", GetAddressesFromLocationName),
        DECLARE_NAPI_FUNCTION("isGeoServiceAvailable", IsGeoServiceAvailable),
        DECLARE_WRITABLE_NAPI_FUNCTION("getCachedGnssLocationsSize", GetCachedGnssLocationsSize),
        DECLARE_WRITABLE_NAPI_FUNCTION("flushCachedGnssLocations", FlushCachedGnssLocations),
        DECLARE_WRITABLE_NAPI_FUNCTION("sendCommand", SendCommand),
...
static napi_value InitManager(napi_env env, napi_value exports)
{
    ...
    napi_property_descriptor desc[] = {
        ...
        DECLARE_NAPI_FUNCTION("disableLocation", DisableLocation),
        DECLARE_NAPI_FUNCTION("requestEnableLocation", RequestEnableLocation),
        DECLARE_WRITABLE_NAPI_FUNCTION("isGeocoderAvailable", IsGeoServiceAvailable),
        DECLARE_WRITABLE_NAPI_FUNCTION("getAddressesFromLocation", GetAddressesFromLocation),
        DECLARE_WRITABLE_NAPI_FUNCTION("getAddressesFromLocationName", GetAddressesFromLocationName),
        ...
        DECLARE_WRITABLE_NAPI_FUNCTION("flushCachedGnssLocations", FlushCachedGnssLocations),
        DECLARE_WRITABLE_NAPI_FUNCTION("sendCommand", SendCommand),
        DECLARE_WRITABLE_NAPI_FUNCTION("getCountryCode", GetIsoCountryCode),
        ...
        DECLARE_NAPI_FUNCTION("findMatchingWlan", FindMatchingWlan),
        ...
        DECLARE_NAPI_FUNCTION("isGnssServiceSupported", IsGnssServiceSupported),
        DECLARE_NAPI_FUNCTION("isGnssFenceServiceSupported", IsGnssFenceServiceSupported),
        DECLARE_NAPI_FUNCTION("isCachedGnssServiceSupported", IsCachedGnssServiceSupported),
