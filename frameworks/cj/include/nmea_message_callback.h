...
#ifndef NMEA_MESSAGE_CALLBACK_H
#define NMEA_MESSAGE_CALLBACK_H
...
class NmeaMessageCallback : public IRemoteStub<Location::INmeaMessageCallback> {
public:
    NmeaMessageCallback();
    NmeaMessageCallback(int64_t callbackId);
    virtual ~NmeaMessageCallback();
