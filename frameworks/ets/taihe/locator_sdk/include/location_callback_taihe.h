...
#ifndef LOCATOR_CALLBACK_TAIHE_H
#define LOCATOR_CALLBACK_TAIHE_H
...
namespace OHOS {
namespace Location {
class LocatorCallbackTaihe : public IRemoteStub<ILocatorCallback> {
public:
    LocatorCallbackTaihe();
    virtual ~LocatorCallbackTaihe();
    ...
    ::taihe::optional<taihe::callback<void(::ohos::geoLocationManager::Location const&)>> callback_;
...
#endif // LOCATOR_CALLBACK_TAIHE_H
