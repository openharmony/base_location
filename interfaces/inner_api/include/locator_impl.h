...
public:
    ...
    /**
     * Get perform locating app list.
     *
     * @return Returns ERRCODE_SUCCESS if Get perform locating app list.
     */
    LocationErrCode GetAppsPerformLocating(std::vector<AppIdentity>& performLocatingAppList);
