...
enum {
    ...
    GEOCODE_REQUEST,
    SA_LOAD,
    ANCO_NETWORK_LOCATION_START,
    ANCO_GNSS_REQUEST_START,
    ANCO_NETWORK_LOCATION_STOP,
    ANCO_GNSS_REQUEST_STOP,
    ANCO_RECEIVE_GNSS_LOCATION,
    ANCO_RECEIVE_NETWORK_LOCATION,
    ANCO_GEO_CODE,
    LBS_REQUEST_FAIL_DETAIL,
    LBS_USER_DATA_SIZE,
    CANCEL_CARD,
    LEAVE_CAR,
    CAR_FEATURE_LEARNING_RESULT,
    POP_UP_CARD,
    CAR_FEATURE_LEARNING_FAILED,
    CAR_MAC_MATCH_FAILED,
    POP_CARD_FAILED,
    CANCEL_CARD_FAILED,
    REPORT_ON_CAR_TWICE,
    IDENTIFY_LEAVE_CAR_FAILED,
    GET_ON_CAR,
    START_GNSS_CACHE,
    STOP_GNSS_CACHE
};
