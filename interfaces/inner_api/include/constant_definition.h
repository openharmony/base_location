...
constexpr const char* SEARCH_NET_WORK_STATE_CHANGE_ACTION = "com.hos.action.SEARCH_NET_WORK_STATE_CHANGE";
constexpr const char* SIM_STATE_CHANGE_ACTION = "com.hos.action.SIM_STATE_CHANGE";
