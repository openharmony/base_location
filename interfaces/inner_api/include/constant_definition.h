...
const double DEFAULT_APPROXIMATELY_ACCURACY = 50.0;
...
const int32_t MAX_BLUETOOTH_SEARCH_CALLBACK_NUM = 5;
const int32_t DEFAULT_RSSI_THRESHOLD = -1000;
...
enum {
    ...
    COUNTRY_CODE_FROM_CURRENT_LOCATION
};
