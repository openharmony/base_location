...
public:
    ...
    static GeocodeConvertAddressRequest* Unmarshalling(Parcel& parcel);
    void ReadFromParcel(Parcel& parcel);
    static std::unique_ptr<GeocodeConvertAddressRequest> UnmarshallingMessageParcel(MessageParcel& parcel);
