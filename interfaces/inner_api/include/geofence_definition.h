...
enum SensorGeofenceTransition {
    SENSOR_GEOFENCE_TRANSITION_ENTERED = (1 << 0),
    SENSOR_GEOFENCE_TRANSITION_EXITED = (1 << 1),
    SENSOR_GEOFENCE_TRANSITION_UNCERTAIN = (1 << 2),
    SENSOR_GEOFENCE_TRANSITION_DWELL = (1 << 3),
    SENSOR_GEOFENCE_TRANSITION_INDOOR = (1 << 4),
    SENSOR_GEOFENCE_TRANSITION_OUTDOOR = (1 << 5),
    SENSOR_GEOFENCE_TRANSITION_NEAR = (1 << 6),
    SENSOR_GEOFENCE_TRANSITION_NEAR_WANDER = (1 << 7),
    SENSOR_GEOFENCE_TRANSITION_FAR = (1 << 8),
};
