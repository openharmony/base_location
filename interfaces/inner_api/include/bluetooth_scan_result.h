...
public:
    ...
    static std::unique_ptr<BluetoothScanResult> Unmarshalling(Parcel& parcel);
    static std::shared_ptr<BluetoothScanResult> UnmarshallingShared(Parcel& parcel);
    void VectorString16ToVectorUint8(const std::vector<std::u16string>& additions);
    std::vector<std::u16string> VectorUint8ToVectorString16() const;
